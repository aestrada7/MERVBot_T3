	...
	case EVENT_ArenaEnter:
		{
			...
			botVersion = "0.0.4 (2025/2/10)";
			botName = "T3G Public Bot (HAL9001)";
			botDLL = "hal9001.dll";
			botSettings = "hal9001.ini";
	...
	case EVENT_PlayerMove:
		{
			...
			// no anti in center
			int radius = 105; //todo - move to the ini file
...
void Logger::log(const char *msg)
{
	...
	std::ofstream logFile("hal9001.log", std::ios::app);
	if(logFile.is_open())
	{
